      ...
      <div className="container mx-auto px-6 pt-32 pb-24 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-4 sm:gap-8 mb-32 md:mb-56">
          ...
          <div className="col-span-12 md:col-span-5 grid grid-rows-2 gap-4 sm:gap-8">
            ...
            >
              ...
              <p className="text-blue-100 font-bold uppercase tracking-widest text-sm">Yillik tajriba</p>
            </motion.div>
          ...
          <div className="flex flex-col items-start justify-start mb-24 md:mb-32 gap-10">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-7xl font-heading font-black text-slate-900 tracking-tighter uppercase leading-[0.85]">
                Bizning <br/> <span className="text-[#C5A037] italic">Qadriyatlarimiz</span>
              </h2>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 30 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            {aboutPoints.map((point, i) => (
              <motion.div
                ...
                className={`group relative p-12 rounded-[3.5rem] flex flex-col items-start transition-all duration-700 bg-white border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.03)] hover:shadow-[0_40px_80px_rgba(0,0,0,0.08)] hover:-translate-y-6 ${
                  i === 1 ? 'lg:translate-y-16' : i === 3 ? 'lg:translate-y-16' : ''
                }`}
              >
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto">
            <Award className="w-20 h-20 text-[#C5A037] mx-auto mb-10 animate-bounce" />
            <h2 className="text-xl sm:text-5xl md:text-7xl font-heading font-black leading-none mb-12 tracking-tighter uppercase italic">
              "Bizning asosiy <span className="text-blue-500">ishonchimiz</span> - ta'lim orqali <span className="text-[#C5A037]">hayotlarni</span> o'zgartirishdir"
            </h2>
            <p className="text-xl sm:text-2xl text-slate-400 font-medium leading-relaxed italic">
              {lang === 'uz' 
                ? "Biz shunchaki o'qitmaymiz, biz ilhomlantiramiz. Bizning maqsadimiz - har bir talabaning ichidagi cheksiz imkoniyatlarni kashf etish." 
                : lang === 'ru' 
                ? "Мы не просто учим, мы вдохновляем. Наша цель — раскрыть безграничные возможности внутри каждого ученика."
                : "We don't just teach, we inspire. Our goal is to discover the limitless possibilities within each student."}
            </p>
          </div>
        ...
        <div className="text-center">
          ...
          >
            <h2 className="text-3xl sm:text-6xl font-black text-slate-900 mb-12 uppercase tracking-tighter">
              Siz ham <span className="text-blue-600 italic">o'z yo'lingizni</span> <br/> biz bilan boshlang
            </h2>
            <Link to="/contact">
