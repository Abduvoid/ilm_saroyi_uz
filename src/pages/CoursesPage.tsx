      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 sm:space-y-6">
                {[
                  { t: "Individual yondashuv", d: "Har bir talabaning o'zlashtirish darajasiga qarab darslar tashkil etiladi." },
                  { t: "Zamonaviy metodika", d: "Nazariya va amaliyot uyg'unligidagi eng so'nggi o'qitish usullari." },
                  { t: "Karyera markazi", d: "Talabalarni ishga joylashtirish va portfoliolarini shakllantirishda ko'mak." }
                ].map((item, i) => (
                  <div key={i} className="flex gap-4 sm:gap-6">
                    ...
                    <div>
                      <h4 className="text-lg sm:text-xl font-bold text-slate-900 mb-1 sm:mb-2">{item.t}</h4>
                      <p className="text-sm sm:text-base text-slate-600">{item.d}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-6 bg-[#C5A037] text-white p-4 sm:p-8 rounded-xl sm:rounded-3xl shadow-xl">
                ...
                <div className="text-[10px] sm:text-sm font-bold opacity-80 uppercase">Amaliy bilimlar</div>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-8">O'zingizga mos kursni tanlashda qiynalyapsizmi?</h2>
            ...
            <Link to="/contact">
              <Button size="lg" className="bg-[#C5A037] hover:bg-[#b08d2f] text-white rounded-full px-8 sm:px-12 py-5 sm:py-8 text-base sm:text-xl font-bold transition-all hover:scale-105 shadow-2xl">
